...
import app.consumerApp.test.HelpCenterImplementation;
import app.consumerApp.test.HelpDeskImplementation;

public class HelpCenterFeatureTest extends DriverIgnit {

	
	HelpCenterImplementation helpCenterimpl = new HelpCenterImplementation();
	...
	{
		helpCenterimpl.setUpAllVariable();
	}

	@Test (priority =1,description= "To check the UI and functionality of Helpcenter screen.")
	public void Test_Verify_UI_And_Functionality() throws InterruptedException
	{
		helpCenterimpl.verify_UI_And_Functionality();
	}
